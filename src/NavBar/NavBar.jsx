    ...
    <div className="">
      <div className=" flex justify-between py-4   flex-col lg:flex-row    ">
        ...
        <div className="flex justify-center ">
          <ul className="flex justify-center items-center text-[#0B0B0B]  flex-col lg:flex-row gap-1 lg:gap-8  font-Inter font-semibold">
            <label className="swap  w-[10px] swap-rotate">
              <input
                onClick={toggleTheme}
                type="checkbox"
              ...
              {/* moon icon */}
              <svg
                className="swap-off dark:text-white fill-current w-10 h-10"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
